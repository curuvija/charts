...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"adonato/query-exporter","tag":"2.10.0"}` | Image to use for deployment |
...
| image.tag | string | `"2.10.0"` | Overrides the image tag whose default is the chart appVersion. |
